...
use App\Mail\GuestUserReviewReportMail;
...
class GuestUserReviewReport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'guest_user_review_report:generate';
...
if(empty($business->is_report_email_enabled)) {
    ...
    $pdf = PDF::loadView('guest-user-review-report-pdf', compact("data","business","start_date_of_previous_week","end_date_of_previous_week"));
